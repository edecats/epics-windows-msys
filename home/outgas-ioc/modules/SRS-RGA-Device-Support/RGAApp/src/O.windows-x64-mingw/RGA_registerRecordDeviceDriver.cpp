...
/* Generated from ../O.Common/RGA.dbd */
...
int RGA_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/outgas-ioc/modules/SRS-RGA-Device-Support";
...
/* RGA_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"RGA_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(RGA_registerRecordDeviceDriver(*iocshPpdbbase));
}
