...
/* Generated from ../O.Common/TPG.dbd */
...
int TPG_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/outgas-ioc/modules/Pfeiffer-Controller-Device-Support";
...
/* TPG_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"TPG_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(TPG_registerRecordDeviceDriver(*iocshPpdbbase));
}
