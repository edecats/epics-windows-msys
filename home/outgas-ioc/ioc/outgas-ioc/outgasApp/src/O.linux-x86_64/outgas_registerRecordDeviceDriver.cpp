...
/* Generated from ../O.Common/outgas.dbd */
...
static const char * const deviceSupportNames[] = {
    ...
    "devlongoutStream", "devLsiSoft", "devLsiEnviron", "devlsiStream",
    "devLsoSoft", "devLsoSoftCallback", "devLsoStdio", "devlsoStream",
...
int outgas_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/opt/radiabeam/ioc/outgas-ioc";
...
/* outgas_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"outgas_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(outgas_registerRecordDeviceDriver(*iocshPpdbbase));
}
