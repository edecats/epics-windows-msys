...
#define EPICS_VERSION_SHORT  "7.0.4.1"
#define EPICS_VERSION_FULL   "7.0.4.1"
#define EPICS_VERSION_STRING "EPICS 7.0.4.1"
#define epicsReleaseVersion  "EPICS R7.0.4.1"

#ifndef VERSION_INT
#  define VERSION_INT(V,R,M,P) ( ((V)<<24) | ((R)<<16) | ((M)<<8) | (P))
#endif
#define EPICS_VERSION_INT VERSION_INT(7, 0, 4, 1)
